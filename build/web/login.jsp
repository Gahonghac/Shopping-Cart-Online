<%-- 
    Document   : error
    Created on : Mar 2, 2023, 9:19:57 PM
    Author     : flami
--%>
        ...
        <div class="grid">
            ...
            <form action="MainController" method="POST" class="form login">
                ...
                <div class="form__field">
                    ...
                    <input autocomplete="username" id="login__username" type="text" name="userID"
            ...
            <p class="text--center">Not a member? <a href="createUser.jsp">Sign up now</a> 
                <svg class="icon">
                <use xlink:href="#icon-arrow-right"></use>
                </svg>
            </p>
            <form action="shopping.jsp" method="POST" class="form login">
                <div class="form__field">
                    <input type="submit" name="action" value="Shopping Cart"><br/>
                </div>
            </form>
